...
$conn=my_connect();
$query = "select * from rent ORDER BY rid ASC";  
...
<body>
  ...
  <div class="collapse navbar-collapse text-center" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="smain.php">For Sale</a>
      </li>
      <li class="nav-item">
	...
	<?php  
                ...
                <div class="col-md-4">     
                          <div class="card" style="width:600px;margin-bottom: 20px;" align="center">
							    ...
							    <p class="card-text text-danger">Rs <?php echo $row["hprice"];?> pm</p>
							    <p class="card-text">Description :- <?php echo $row["desc"];?></p>
							    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $row["rid"]; ?>">
...
<!-- The Modal -->
<div class="modal" id="myModal<?php echo $row["rid"]; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="modal-dialog">Rs <?php echo $row["hprice"];?> pm</p>
