...
$conn=my_connect();
$sql="select * from sale where oname='$oname' and hlocation='$hlocation'";
...
if ($num==1) {
	...
	$sql =  "INSERT INTO `homeinfo`.`sale` (`sid`, `oname`, `oadd`, `mail`, `phone`, `hlocation`, `desc`, `hprice`, `img`) VALUES (NULL, '$oname', '$oadd', '$mail', '$phone', '$hlocation', '$desc', '$hprice', '$destination')";
	$query = mysqli_query($conn,$sql)or die("unable to execute");
    echo'<script>alert("Form submitted successfull");window.location.href="http://localhost/homeinfo/osale.php";</script>';
     }
	else
		{
			echo'<script>alert("Error in submission of form");window.location.href="http://localhost/homeinfo/osale.php";</script>';
		}
...
<body>
  ...
  <div class="collapse navbar-collapse text-center" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link text-white" href="orent.php">For Rent</a>
      </li>
      <li class="nav-item">
...
<h1 class="heading" ">WELCOME TO SALE PAGE</h1>
